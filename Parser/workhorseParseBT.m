...
BT=ensembles.BT;
  ...
  if BT == 1
    ...
    BTbackscatter1 = bottomTrack.btBeam1EvalAmp; % 0 to 255 counts
    BTbackscatter2 = bottomTrack.btBeam2EvalAmp;
    BTbackscatter3 = bottomTrack.btBeam3EvalAmp;
    BTbackscatter4 = bottomTrack.btBeam4EvalAmp;

    BTcorrelation1 = bottomTrack.btBeam1Corr;
    BTcorrelation2 = bottomTrack.btBeam2Corr;
    BTcorrelation3 = bottomTrack.btBeam3Corr;
    BTcorrelation4 = bottomTrack.btBeam4Corr;

    BTpercentGood1 = bottomTrack.btBeam1PercentGood;
    BTpercentGood2 = bottomTrack.btBeam2PercentGood;
    BTpercentGood3 = bottomTrack.btBeam3PercentGood;
    BTpercentGood4 = bottomTrack.btBeam4PercentGood;

    BTrange1       = bottomTrack.btBeam1Range / 100; % 0 to 65535 cm - to meters
    BTrange2       = bottomTrack.btBeam2Range / 100;
    BTrange3       = bottomTrack.btBeam3Range / 100;
    BTrange4       = bottomTrack.btBeam4Range / 100;

    BTMaxRange     = bottomTrack.btMaxDepth / 10; % decimeters to meters
  %
  % calculate Bottom Track velocity (speed and direction)
  % currently assuming earth coordinate transform
  %  
      BTveast = bottomTrack.btBeam1Vel / 1000; % mm/s to m/s
      BTvnrth = bottomTrack.btBeam2Vel / 1000;
      BTwvel  = bottomTrack.btBeam3Vel / 1000;
      BTevel  = bottomTrack.btBeam4Vel / 1000;
      clear bottomTrack;

      % set all bad values to NaN.
      BTvnrth(BTvnrth == -32768) = NaN;
      BTveast(BTveast == -32768) = NaN;
      BTwvel (BTwvel  == -32768) = NaN;
      BTevel (BTevel  == -32768) = NaN;

      BTspeed = sqrt(BTvnrth.^2 + BTveast.^2);
      BTdirection = getDirectionFromUV(BTveast, BTvnrth);
...
%% If unit has Bottom Track data
  if BT == 1
  
      BTvnrth(iBadOriented, :) = NaN;
      BTveast(iBadOriented, :) = NaN;
      BTwvel(iBadOriented, :) = NaN;
      BTevel(iBadOriented, :) = NaN;
      BTspeed(iBadOriented, :) = NaN;
      BTdirection(iBadOriented, :) = NaN;
      BTbackscatter1(iBadOriented, :) = NaN;
      BTbackscatter2(iBadOriented, :) = NaN;
      BTbackscatter3(iBadOriented, :) = NaN;
      BTbackscatter4(iBadOriented, :) = NaN;
      BTcorrelation1(iBadOriented, :) = NaN;
      BTcorrelation2(iBadOriented, :) = NaN;
      BTcorrelation3(iBadOriented, :) = NaN;
      BTcorrelation4(iBadOriented, :) = NaN;
      BTpercentGood1(iBadOriented, :) = NaN;
      BTpercentGood2(iBadOriented, :) = NaN;
      BTpercentGood3(iBadOriented, :) = NaN;
      BTpercentGood4(iBadOriented, :) = NaN;
  else 
  ...
  if BT == 1
    ...
    vars = {
      ...
      ['BtVCUR' magExt],    [1 2],  BTvnrth,          magBiasComment; ...
      ['BtUCUR' magExt],    [1 2],  BTveast,          magBiasComment; ...
      'BtWCUR',             [1 2],  BTwvel,           ''; ...
      'BtCSPD',             [1 2],  BTspeed,          ''; ...
      ['BtCDIR' magExt],    [1 2],  BTdirection,      magBiasComment; ...
      'BtECUR',             [1 2],  BTevel,           ''; ...
      'BtABSIC1',           [1 3],  BTbackscatter1,   ''; ...
      'BtABSIC2',           [1 3],  BTbackscatter2,   ''; ...
      'BtABSIC3',           [1 3],  BTbackscatter3,   ''; ...
      'BtABSIC4',           [1 3],  BTbackscatter4,   ''; ...
      'BtCMAG1',            [1 3],  BTcorrelation1,   ''; ...
      'BtCMAG2',            [1 3],  BTcorrelation2,   ''; ...
      'BtCMAG3',            [1 3],  BTcorrelation3,   ''; ...
      'BtCMAG4',            [1 3],  BTcorrelation4,   ''; ...
      'BtPERG1',            [1 2],  BTpercentGood1,   ''; ...
      'BtPERG2',            [1 2],  BTpercentGood2,   ''; ...
      'BtPERG3',            [1 2],  BTpercentGood3,   ''; ...
      'BtPERG4',            [1 2],  BTpercentGood4,   ''; ...
      };
  ...
  clear vnrth veast wvel evel speed direction backscatter1 ...
      ...
      heading voltage BTvnrth BTveast BTwvel BTevel BTspeed BTdirection ...
      BTbackscatter1 BTbackscatter2 BTbackscatter3 BTbackscatter4 ...
      BTcorrelation1 BTcorrelation2 BTcorrelation3 BTcorrelation4 ...
      BTpercentGood1 BTpercentGood2 BTpercentGood3 BTpercentGood4 ...
      salinty pitch roll heading voltage;
  ...
  for i=1:nVars
      ...
      % If Bottom Track data is present then compass corrections of the BT data is needed
      if BT == 1    
          if any(strcmpi(vars{i, 1}, {'VCUR', 'UCUR', 'CDIR', 'HEADING', 'BtVCUR', 'BtUCUR', 'BtWCUR', 'BtCDIR'}))
              sample_data.variables{i}.compass_correction_applied = magDec;
          elseif any(strcmpi(vars{i, 1}, {'VCUR', 'UCUR', 'CDIR', 'HEADING'}))
              sample_data.variables{i}.compass_correction_applied = magDec;
          end
      end
  end
  clear vars;
  clear BT; % to clear the BTrack trigger before the next instrument
...
%% The waveData if present, gets stored in the second dimension of sample_data  
  if isWaveData
      %
